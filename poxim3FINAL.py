...
arqInput = open("1_exemplo.hexCACHE.txt",'r')
arqOutput = open("saidaCACHE.txt",'w')
hexa = []
...
def cacheInicializador():   
    listaHelpLinhas = ["000","001","010","011","100","101","110","111"]
    for k in listaHelpLinhas:
        cacheInstrucao[k] = [[0,0,"identificador","0x00000000","0x00000000","0x00000000","0x00000000"],[0,0,"identificador","0x00000000","0x00000000","0x00000000","0x00000000"]]
    listaHelpLinhas.clear()

def check():
    valu = list(cacheInstrucao.values())
    instCheck = ''
    for v in valu:
        if (hexa[posicao] in v[0]):
            instCheck = hexa[posicao]
            return instCheck
            #break
        elif (hexa[posicao] in v[1]):
            instCheck = hexa[posicao]
            return instCheck
            #break
        else:
...
def cacheCHECKinstrucao():
    print(check())
    
    if ((cacheInstrucao[linha])[0])[0] == 0: # check de Validade igual a N:
        imprimir = f"	I_read_miss [0]          	[0][VAL=0,AGE=0,ID=0x000000],[1][VAL=0,AGE=0,ID=0x000000]"
        arqOutput.write(pc+":"+imprimir+"\n")
        ((cacheInstrucao[linha])[0])[0] = 1
        ((cacheInstrucao[linha])[0])[1] = idade
        ((cacheInstrucao[linha])[0])[2] = identificador
        posicionaPalavrasINSTRUCAO()
    elif ((cacheInstrucao[linha])[1])[0] == 0: # check de Validade igual a N:
        imprimir = f"	I_read_miss [0]          	[0][VAL=0,AGE=0,ID=0x000000],[1][VAL=0,AGE=0,ID=0x000000]"
        arqOutput.write(pc+":"+imprimir+"\n")
        ((cacheInstrucao[linha])[1])[0] = 1
        ((cacheInstrucao[linha])[1])[1] = idade
        ((cacheInstrucao[linha])[1])[2] = identificador
        posicionaPalavrasINSTRUCAO()
    
                

def posicionaPalavrasINSTRUCAO():
    # INSTRUCOES
    ident = 0
    if ((cacheInstrucao[linha])[0])[2] != identificador:
        ident = 1

    if palavra == "00":
        ((cacheInstrucao[linha])[ident])[3] = hexa[posicao]
        ((cacheInstrucao[linha])[ident])[4] = hexa[posicao+1]
        ((cacheInstrucao[linha])[ident])[5] = hexa[posicao+2]
        ((cacheInstrucao[linha])[ident])[6] = hexa[posicao+3]
    elif palavra == "01":
        ((cacheInstrucao[linha])[ident])[3] = hexa[posicao-1]
        ((cacheInstrucao[linha])[ident])[4] = hexa[posicao]
        ((cacheInstrucao[linha])[ident])[5] = hexa[posicao+1]
        ((cacheInstrucao[linha])[ident])[6] = hexa[posicao+2]
    elif palavra == "10":
        ((cacheInstrucao[linha])[ident])[3] = hexa[posicao-2]
        ((cacheInstrucao[linha])[ident])[4] = hexa[posicao-1]
        ((cacheInstrucao[linha])[ident])[5] = hexa[posicao]
        ((cacheInstrucao[linha])[ident])[6] = hexa[posicao+1]
    elif palavra == "11":
        ((cacheInstrucao[linha])[ident])[3] = hexa[posicao-3]
        ((cacheInstrucao[linha])[ident])[4] = hexa[posicao-2]
        ((cacheInstrucao[linha])[ident])[5] = hexa[posicao-1]
        ((cacheInstrucao[linha])[ident])[6] = hexa[posicao]

def posicionaPalavrasDados():
    # INSTRUCOES
    if palavra == "00":
        ((cacheInstrucao[linha])[0])[3] = hexa[posicao]
        ((cacheInstrucao[linha])[0])[4] = hexa[posicao+1]
        ((cacheInstrucao[linha])[0])[5] = hexa[posicao+2]
        ((cacheInstrucao[linha])[0])[6] = hexa[posicao+3]
    elif palavra == "01":
        ((cacheInstrucao[linha])[0])[3] = hexa[posicao-1]
        ((cacheInstrucao[linha])[0])[4] = hexa[posicao]
        ((cacheInstrucao[linha])[0])[5] = hexa[posicao+1]
        ((cacheInstrucao[linha])[0])[6] = hexa[posicao+2]
    elif palavra == "10":
        ((cacheInstrucao[linha])[0])[3] = hexa[posicao-2]
        ((cacheInstrucao[linha])[0])[4] = hexa[posicao-1]
        ((cacheInstrucao[linha])[0])[5] = hexa[posicao]
        ((cacheInstrucao[linha])[0])[6] = hexa[posicao+1]
    elif palavra == "11":
        ((cacheInstrucao[linha])[0])[3] = hexa[posicao-3]
        ((cacheInstrucao[linha])[0])[4] = hexa[posicao-2]
        ((cacheInstrucao[linha])[0])[5] = hexa[posicao-1]
        ((cacheInstrucao[linha])[0])[6] = hexa[posicao]
            ...
            if operacao == "000000" and c.rfind("1") != -1:  
                ...
                if imed[:3] == "000":
                    ...
                    if num2 == 0:
                        ...
                        sr[26] = "0"
                    n1 = (completaZeroBin(bin(int(num1,2)).strip("-")[2:]))
                    n2 = (completaZeroBin(bin(int(num2,2)).strip("-")[2:]))
